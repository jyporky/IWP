...
public class UpgradeStat : MonoBehaviour
{
    ...
    private UpgradeStatSO upgradeItemSO;
    ...
    /// </summary>
    public void SetUpgradeItemSO(UpgradeStatSO upgradeItemSOReference, UpgradeType upgradeTypeReference, UpgradeStationManagerUI upgradeStationManagerRef)
    {
        upgradeStationManagerUI = upgradeStationManagerRef;
        upgradeStationManagerUI.onPurchase += UpdateLevelAndCost;
    ...
    /// </summary>
    public UpgradeStatSO GetUpgradeItemSO()
    {
